...
Select-AzureRmSubscription -SubscriptionId "c001459f-a8b7-407a-a62f-6200a8033801"
...
#$Primedatabasename="sheik-Prime"
#$Primedatabasesize="S1"
#$Tenantdatabasename="Sheik-tenent"
#$Tenantdatabasesize="S0"
#$WFdatabasesize="S0"
#$WFdatabasename=
...
#New-AzureRmSqlDatabase  -ResourceGroupName $resourcegroupname -ServerName $AzureSqlServerNameLowerCase -DatabaseName $Tenantdatabasename -RequestedServiceObjectiveName $Tenantdatabasesize
#New-AzureRmSqlDatabase  -ResourceGroupName $resourcegroupname -ServerName $AzureSqlServerNameLowerCase -DatabaseName $WFdatabasename -RequestedServiceObjectiveName $WFdatabasesize
